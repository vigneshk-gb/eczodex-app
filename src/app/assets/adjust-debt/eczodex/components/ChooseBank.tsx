...
const styles = {
  ...
  depositContainer: `w-full md:w-[35rem] h-auto mx-auto px-[0.5rem] md:px-[1rem]`,
    ...
    transferFromItem: `w-auto h-fit border-box p-[0.34rem] border-[#E4E3EB] border-[1px] border-solid rounded-[0.5rem] flex md:flex-col items-center justify-evenly md:justify-center gap-[0.5rem] md:gap-[0.94rem]`,
    transferFromItemActive: `w-auto h-fit p-[0.34rem] bg-[#449ECF] bg-opacity-5 border-[#449ECF] border-[1px] border-solid rounded-[0.5rem] flex md:flex-col items-center justify-evenly md:justify-center gap-[0.5rem] md:gap-[0.94rem]`,
