...
const styles = {
  ...
  adjustDebt: `w-full max-w-[90%] min-h-screen bg-[#ffff] border-[#E4E3EB] border-[1px] border-solid mx-auto md:my-[0.5rem] self-center rounded-[1rem] p-[1rem] md:p-[2.5rem]`,
  headContainer: `flex`,
