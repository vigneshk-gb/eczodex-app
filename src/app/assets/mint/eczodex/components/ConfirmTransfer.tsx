...
const styles = {
  ...
  transferContainer: `w-full h-auto mx-auto px-[0.5rem] md:px-[1rem] flex flex-col justify-evenly items-center gap-[1rem]`,
  topContainer: `w-full max-md:flex-col flex md:items-end gap-y-[1.5rem] gap-x-[2.5rem]`,
  ...
  return (
    <>
        ...
        <div className={styles.topContainer}>
          <div className={styles.inputContainer}>
            <div className={styles.inputTitleWrapper}>
              <div className={styles.inputTitle}>Amount to Mint</div>
            </div>
      ...
      <div className={styles.bottomContainer}>
        ...
        <div className={styles.inputContainer}>
          <div className={styles.inputTitleWrapper}>
            <div className={styles.inputTitle}>Beneficiary Account Name</div>
          </div>
          <div className={styles.inputWrapper}>
            <input type="number" className={styles.inputBox} />
          </div>
        ...
        <div className={styles.inputContainer}>
          <div className={styles.inputTitleWrapper}>
            <div className={styles.inputTitle}>Beneficiary Account No.</div>
          </div>
          <div className={styles.inputWrapper}>
            <input type="number" className={styles.inputBox} />
          </div>
        ...
        <div className={styles.inputContainer}>
          <div className={styles.inputTitleWrapper}>
            <div className={styles.inputTitle}>Beneficiary Address</div>
          </div>
          <div className={styles.inputWrapper}>
            <input type="number" className={styles.inputBox} />
          </div>
