...
const styles = {
  ...
  activemenuItemL: `basis-1/5 bg-[#2B8AC8] p-[1rem] border-[#E4E3EB] border-b-[1px] border-solid text-center text-[0.8rem] font-[400] tracking-[0.1rem] uppercase text-[#ffff]`,
  ...
  return (
    <div className={styles.mint}>
      ...
      <div className={styles.mintBox}>
        ...
        {activeTab === "one" && <SelectAsset />}
        {activeTab === "two" && <MintDetails />}
      ...
      {activeTab === "three" && (
        <>
          ...
          <div className={styles.exitBtn}>
            Exit deposit and add a bank account
          </div>
        </>
      )}
      {activeTab === "four" && (
      ...
      {activeTab === "five" && (
        <div onClick={() => setActiveTab("six")} className={styles.primaryBtn}>
          Next
        </div>
      )}
    </div>
