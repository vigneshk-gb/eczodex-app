...
const styles = {
  ...
  beneficiaryContainer: `w-full md:max-w-[45rem] h-auto mx-auto flex flex-wrap justify-evenly items-center gap-[0.62rem] px-[0.5rem] md:px-[1rem]`,
  beneficiaryItem: `relative w-full md:w-[21rem] h-[12rem] md:h-[14rem] flex flex-col px-[1.56rem] py-[1rem] items-start justify-between border-[#E4E3EB] border-[1px] border-solid rounded-[0.5rem]`,
  ...
  return (
    <>
      <div className={styles.subHead}>
        ...
        <div className={styles.subHeadText}>Selsect Beneficiary Account</div>
        <hr className={styles.hr} />
      </div>
