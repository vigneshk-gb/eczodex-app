...
const styles = {
  ...
  tableHeadTicker: `basis-1/2 self-center flex gap-[0.62rem] px-[0.87rem]`,
  ...
  tableItemWrapper: `w-full h-auto flex flex-col border-[#E4E3EB] rounded-[0.5rem] border border-solid min-w-[18rem] md:min-w-[58rem]`,
  tableBodyContainer: `w-full h-fit min-h-[4.56rem] max-md:flex-col flex md:items-center `,
  tableSubContainerFirst: `w-full h-fit md:basis-4/12 p-[0.5rem] flex items-center max-md:justify-between`,
  tableSubContainerSecond: `w-full h-fit max-md:order-last md:basis-4/12 p-[0.5rem] flex items-center max-md:justify-between`,
  tableSubContainerThird: `w-full h-fit md:basis-4/12 p-[0.5rem] flex items-center max-md:justify-between`,
  ...
  tableBodyItem: `w-fit md:basis-1/2  h-full flex items-center self-center px-[0.87rem]`,
  tableBodyTicker: `w-fit md:basis-1/2 h-full  flex items-center justify-start gap-[1.25rem] self-center px-[0.87rem]`,
  tableBodyName: ` w-fit md:basis-1/2  max-md:flex gap-x-[0.3rem] items-center self-center px-[0.87rem]`,
  tableBodyDate: `w-fit md:basis-1/2 self-center px-[0.87rem]`,
  tableBodyAmount: `w-fit md:basis-1/2 self-center px-[0.87rem]`,
  tableBodyEczBorrowed: `w-fit md:basis-1/2 max-md:flex-col max-md:flex self-center px-[0.87rem] flex items-start md:items-center justify-between`,
  tableBodyCurrentCollateralValue: `w-fit md:basis-1/2 max-md:flex-col max-md:flex self-center px-[0.87rem] flex items-end md:items-center justify-between`,
