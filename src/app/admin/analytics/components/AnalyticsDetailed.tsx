...
const styles = {
  ...
  analytics: `w-full md:w-[98%] min-h-screen h-fit  self-center mx-auto overflow-hidden flex flex-col gap-y-[1rem] justify-between max-md:p-[1rem]`,
  ...
  dashRightCtn: `flex-1 w-full h-fit min-w-[21.47rem] md:min-h-[21.47rem] h-fit mt-[2rem]`,
